...
class ScriptArguments:
    ...
    output_dir: Optional[str] = field(default="r512-b4-a1-seq512-l2.0e-5", metadata={"help": "The output directory"})
    peft_lora_r: Optional[int] = field(default=512, metadata={"help": "The r parameter of the LoRA adapters"})
    peft_lora_alpha: Optional[int] = field(default=1, metadata={"help": "The alpha parameter of the LoRA adapters"})
